...
// -- ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ - Your Answer - ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ -- //
function Person(inputPersonName) {
  this.age = 0
  this.ageAYear = function() {
    this.age += 1
  }
  this.name = inputPersonName
}
...
var wens = new Person('wensie')

ajaxAger = wens.ageAYear.bind(ajax)
...
var getEmail = { 
	this.data function(profileData){}
...
// -- ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ - Your Answer - ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ -- //
LoggingService.prototypetoggleStatus.call(record1)
LoggingService.prototypetoggleStatus.call(record2)
LoggingService.prototypetoggleStatus.call(record3)
